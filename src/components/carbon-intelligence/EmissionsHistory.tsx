...
export function EmissionsHistory() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-white mb-3">Storico Emissioni</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-800">
                ...
                <th className="text-right py-3 px-3 font-medium text-gray-400">CO2 (ton)</th>
                <th className="text-right py-3 px-3 font-medium text-gray-400">Target (ton)</th>
                <th className="text-right py-3 px-3 font-medium text-gray-400">Delta (ton)</th>
                <th className="text-center py-3 px-3 font-medium text-gray-400">Stato</th>
                <th className="text-left py-3 px-3 font-medium text-gray-400">Indicatore</th>
              </tr>
            </thead>
            <tbody>
              {mockEmissionsHistory.map((entry) => {
                ...
                return (
                  <tr key={entry.month} className="border-b border-gray-800 last:border-b-0">
                    <td className="py-3 px-3 text-white font-medium">{entry.month}</td>
                    <td className="py-3 px-3 text-gray-300 text-right">{entry.co2Tons.toFixed(1)}</td>
                    <td className="py-3 px-3 text-gray-300 text-right">{entry.target.toFixed(1)}</td>
                    ...
                    <td className="py-3 px-3">
                      <div className="flex items-center gap-2">
                        <div className="flex-1 h-2 bg-gray-800 rounded-full overflow-hidden min-w-[100px]">
                          <div
